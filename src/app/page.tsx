...
import { HeroMotion, Reveal } from "../features/landing/motion.tsx";
  ...
  return (
    <div className="landing-page">
      ...
      <main>
        <section aria-labelledby="hero-title" className="landing-hero">
          <HeroMotion>
            <div className="landing-hero-copy landing-container">
              <p className="landing-hero-brand">DeployLens</p>
              <h1 id="hero-title">
                Ask why the metric moved. Get the incident, not a paragraph.
              </h1>
              <p className="landing-lede">
                Turn one checkout conversion question into a linked timeline, funnel, and segment
                finding your team can act on.
              </p>
          ...
          <div className="landing-hero-stage" id="product">
            <div className="landing-question landing-container">
              ...
              <Link aria-label="Open this investigation in DeployLens" className="landing-question-go" href="/app">
                Open
              </Link>
            </div>
        ...
        <section aria-labelledby="progress-title" className="landing-section landing-progress-band">
          <div className="landing-container">
            <Reveal>
              <div className="landing-section-intro">
                <h2 id="progress-title">A guided investigation, start to finish.</h2>
                <p>Every demo run follows the same evidence path so the cause stays reproducible.</p>
              </div>
          ...
          <div className="landing-container">
            ...
            <ol className="landing-workflow-list">
              {workflow.map(({ description, label }, index) => (
                <Reveal delay={0.05 * (index + 1)} key={label}>
                  <li>
          ...
          <div className="landing-container">
            <Reveal>
              <div className="landing-section-intro">
                ...
                <p>
                  Select a segment in the interactive preview. The finding, timeline, funnel, and
                  current evidence all update together.
                </p>
              </div>
            </Reveal>
            <ol className="landing-evidence-chain">
              {evidence.map(({ description, label }, index) => (
                <Reveal delay={0.05 * (index + 1)} key={label}>
                  <li>
                    <span aria-hidden="true" className="landing-evidence-index">
        ...
        <section aria-labelledby="final-cta-title" className="landing-final-cta">
          <div className="landing-container">
            <Reveal>
              <p className="landing-final-brand">DeployLens</p>
              <h2 id="final-cta-title">Stop stitching incidents together by hand.</h2>
              <p className="landing-final-copy">
                Open the seeded checkout workspace and run the same investigation your on-call team
                would ask in production.
              </p>
